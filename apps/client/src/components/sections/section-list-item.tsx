// apps/client/src/components/sections/section-list-item.tsx
...
/**
 * A reusable list item component for section items.
 * This is store-agnostic and can be used in both Resume Builder and Information Bank.
 */
