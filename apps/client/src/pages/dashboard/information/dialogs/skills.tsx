// apps/client/src/pages/dashboard/information/dialogs/skills.tsx
...
export const SkillsInfoDialog = () => {
  const { isOpen, mode, payload, close } = useDialog<FormValues>("info-skills");
