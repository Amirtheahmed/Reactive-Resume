// apps/client/src/pages/dashboard/cover-letters/page.tsx
...
export const CoverLettersPage = () => {
  const [layout, setLayout] = useLocalStorage<Layout>("cover-letter-dashboard-layout", "grid", {
  ...
  return (
    <>
      <Helmet>
        <title>
          {t`Cover Letters`} - {t`Reactive Resume`}
        </title>
      </Helmet>
